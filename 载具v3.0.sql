...
CREATE TABLE durables (
    ...
    durable_capacity INT DEFAULT 0 COMMENT '耐用品容量',
    ...
    factory_id VARCHAR(100) COMMENT '关联工厂ID',
...
('DUR-003', '防静电载具', 'ESD', '防静电', '黑色', 40, 90, 800, 1000, 300, 700, 250, '1');
...
('CA-0001', 'Magazine', '2FUDPZJ', 'DUR-001', 'ATE0-0001', 'P001', 'Released', 'Clean', 'NotOnHold', 10, 0, 'Normal', 'Bank', '2023-04-01'),
('CA-0002', 'HighTemp', 'HT-001', 'DUR-002', 'DBA1-0001', 'P002', 'InUse', 'Clean', 'NotOnHold', 15, 5, 'HighLoad', 'Line', '2023-05-15'),
('CA-0003', 'ESD', 'ESD-001', 'DUR-003', 'ATE0-0002', 'P003', 'Maintenance', 'Dirty', 'OnHold', 20, 0, 'LowLoad', 'RepairArea', '2023-06-01'),
('CA-0004', 'ESD', 'ESD-002', 'DUR-003', 'ATE0-0003', 'P004', 'Maintenance', 'Dirty', 'OnHold', 20, 0, 'Normal', 'RepairArea', '2023-06-10');
